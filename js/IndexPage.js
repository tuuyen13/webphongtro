        ...
        var html = hotposts.map(function(post) {
            ...
            <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                 ...
                 var htmls = html.join('');    
                 document.getElementById("renthome").innerHTML = htmls;
})
}
...
function showRoommate() {
  ...
  .then(function(posts) {
    ...
    var normalposts = posts.filter((post) => post.id < 4);
        var html = normalposts.map(function(post) {
            ...
            <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                    ...
                    <p class="text-body mb-3">${post.shortDes}</p>
                    <div class="d-flex justify-content-between">
                      <a class="btn btn-sm btn-primary rounded py-2 px-4" onclick="RoommateDetails(${post.id})"> Chi Tiết </a>
                        <div>
                            <a class="btn btn-outline-light btn-social" href="${post.contact[2]}"><img src="img/facebook-seeklogo.com.svg" width="25px" height="25px"></img></a>
                            <a class="btn btn-outline-light btn-social" href="${post.contact[3]}"><img src="img/zalo-seeklogo.com.svg" width="25px" height="25px"></img></i></a>
                 ...
                 var htmls = html.join('');    
                 document.getElementById("roommate").innerHTML = htmls;
})
}

function DetailRenthome() {
...
function detailRoommate() {
  ...
  <!-- Carousel End -->
    ...
    <ul>
      ...
      <li><i class="fa-solid fa-wifi"></i> ${post.facilities[2]}</li>
      <li><i class="fa-solid fa-tv"></i> ${post.facilities[3]}</li>
      <li><i class="fa-solid fa-utensils"></i> ${post.facilities[4]}</li>
      <li><i class="fa-solid fa-washer"></i> ${post.facilities[5]}</li>
      <li><i class="fa-solid fa-air-conditioner"></i> ${post.facilities[6]}</li>
    </ul>
    </div>
    <h4>Thông tin liên hệ</h4>
        <div class="aa-properties-single-sidebar">                                  
